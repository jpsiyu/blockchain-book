...
class ArticleWallet extends React.Component {
    ...
    render() {
        return <Article>
            <Paragraph>
                <RawText>
                    Ethereum中的"钱包"同时描述好几样不同的东西。在应用层面，钱包是应用软件，
                    提供访问Ethereum服务的用户接口。钱包控制钥匙的访问权，保管钥匙，设置地址，
                    追踪记录账户的资产，创建交易，为交易签名。部分钱包可以运行Contract。在程序员看来，
            ...
            <Paragraph>
                ...
                <RawText>
                    使用方便与隐私保护之间的平衡，是设计钱包的核心考虑因素。一个私钥，一个地址，重复使用，
                ...
                <RawText>
                    ...
                    控制私钥对应的账户上的ether或token。在传统的支付模式里，客户通知银行转账，
                    银行检查账户余额，确认后转账到对方账户。在Blockchain中，只需要私钥签名，
            ...
            <Paragraph>
                ...
                <RawText>
                    第一代钱包软件，有一个文件专用于存储随机产生的私钥，这种老式的钱包由于自身的缺陷，
                    正在被确定性钱包替代。举个例子，为了更好地保护隐私，账号的地址不应该被重用，
            ...
            <Paragraph>
                ...
                <RawText>
                    ...
                    用户可以设置某些分支用于资金的出口，另外一些分支用于资金的入口。其次，
                    账户公钥可以委托给第三方，第三方根据公钥产生其它公钥，用于接收资金，但是不暴露私钥，
                    第三方无法转移资金。
            </RawText>
            </Paragraph>
            ...
            <Paragraph>
                ...
                <RawText>
                    为了确保私钥的安全，需要对私钥进行加密，加密的方式有很多种，目前推荐的是使用一串有序单词对私钥加密，
                    这一串单词按照正确的顺序，能够解密出私钥，因此也被成为私钥的助记词，
                ...
                <RawText>
                    ...
                    这种错误也很容易被察觉，因为inzect不是合法的单词，没有意思的。把单词抄下来，藏好，
                    是非常有必要的，如果发生硬盘丢失，损坏，这串单词导入到别的钱包软件中，
                    所有的资金和Contract都会在新钱包里恢复。总的来说，用助记词加密种子，
                    使HD钱包用起来方便，安全，容易迁移，有效避免私钥抄写错误。
            </RawText>
            </Paragraph>
        </Article>
    }
